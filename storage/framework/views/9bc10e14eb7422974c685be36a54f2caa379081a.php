...
<div class="container">
 ...
 <div class="col-md-8">
 <div class="card">
 <div class="card-header"><?php echo e(__('Catagory Registration')); ?></div>
 <div class="card-body">
 <form method="POST" action="<?php echo e(route('catagory/register')); ?>"
> <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\laravelproject\ecommerce\resources\views/catagory/register.blade.php ENDPATH**/ ?>