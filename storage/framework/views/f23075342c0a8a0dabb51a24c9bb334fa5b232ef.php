...
<div class="container">
 ...
 <div class="col-md-8">
 <div class="card">
 <div class="card-header"><?php echo e(__('products Registration')); ?></div>
 <div class="card-body">
...
>
 ...
 <div class="col-md-6">
 <input id="id" type="text" class="formcontrol <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
 ...
 <div class="col-md-6">
 <input id="name" type="text" class="formcontrol <?php $__errorArgs = ['id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> isinvalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\laravelproject\ecommerce\resources\views/products/register.blade.php ENDPATH**/ ?>