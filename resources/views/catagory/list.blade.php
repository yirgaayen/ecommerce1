...
<div class="container pb-2">
 <a class="btn btnsuccess" href="{{ route('catagory/register') }}" role="button"> {{ __('catagory') }}
</a>
</div>
<div class="container">
...
name
 ...
 <td>
 <a class="btn btn-xs btninfo" title="Detail" href="/catagory/search/{{ $catagory->id }}">Search</a>
